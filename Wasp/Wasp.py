...
class Wasp(ScriptedLoadableModule):
  def __init__(self, parent):
    ScriptedLoadableModule.__init__(self, parent)
    self.parent.title = "Wasp" # TODO make this more human readable by adding spaces
...
class WaspWidget(ScriptedLoadableModuleWidget):
...
class WaspLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self,inputVolume,outputVolume,enableScreenshots=0,screenshotScaleFactor=1):
    ...
    self.takeScreenshot('Wasp-Start','Start',-1)

    return True


class WaspTest(ScriptedLoadableModuleTest):
  """
  This is the test case for your scripted module.
  """
